...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Character NFT template1</title>
        <meta property="og:title" content="Character NFT template1" />
      </Helmet>
      <header data-thq="thq-navbar" className="home-navbar">
        <img
          alt="image"
          src="/playground_assets/image-removebg-preview%20%5B1%5D-200h.png"
        ...
        >
          <nav
            ...
            className="home-nav"
          >
            <button className="home-button button-clean button">Codes</button>
            <button className="home-button1 button-clean button">Guides</button>
            <button className="home-button2 button-clean button">
              Resources
            </button>
            <button className="home-button3 button-clean button">More</button>
          </nav>
        </div>
        <div data-thq="thq-navbar-btn-group" className="home-btn-group">
          ...
          <button className="home-view button">View on Youtube</button>
        </div>
      ...
      <section className="home-hero">
        <div className="home-heading">
          <h1 className="home-header">
            <span>Development And CyberSec</span>
            <br></br>
          </h1>
        </div>
        <div className="home-buttons">
          <button className="home-view1 button">View on Youtube</button>
      ...
      <section className="home-collection">
        <div className="home-content04">
          <span className="home-caption">collection</span>
        ...
        <div className="home-main3">
          <div className="home-card03">
            ...
            <div className="home-content05">
              <span className="home-caption01">Character #1</span>
          ...
          <div className="home-card04">
            ...
            <div className="home-content06">
              <span className="home-caption02">Character #2</span>
          ...
          <div className="home-card05">
            ...
            <div className="home-content07">
              <span className="home-caption03">Character #3</span>
          ...
          <div className="home-card07">
            ...
            <div className="home-content09">
              <span className="home-caption05">Character #5</span>
          ...
          <div className="home-card08">
            ...
            <div className="home-content10">
              <span className="home-caption06">Character #6</span>
          ...
          <div className="home-card09">
            ...
            <div className="home-content11">
              <span className="home-caption07">Character #7</span>
          ...
          <div className="home-card10">
            ...
            <div className="home-content12">
              <span className="home-caption08">Character #8</span>
      ...
      <section className="home-project">
        <div className="home-understand">
          <div className="home-content13">
            <span className="home-caption09">Project</span>
      ...
      <section className="home-roadmap">
        ...
        <div className="home-list">
          <div className="home-step">
            <span className="home-caption11">01</span>
          ...
          <div className="home-step1">
            <span className="home-caption12">02</span>
          ...
          <div className="home-step2">
            <span className="home-caption13">03</span>
          ...
          <div className="home-step3">
            <span className="home-caption14">04</span>
